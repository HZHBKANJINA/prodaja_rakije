                        ...
                        >
                            ...
                            <form @submit.prevent="onSubmit">
                                <div class="bg-white px-4 pt-5 pb-4">
                                    <CustomInput class="mb-2" modelValue="product.title" label="Product Title"/>
                                    <CustomInput class="mb-2" type="file" label="Product Image" />
                                    <CustomInput type="textarea" class="mb-2" modelValue="product.description" label="Description"/>
                                    <CustomInput type="number" class="mb-2" modelValue="product.price" label="Price" prepend="$"/>
                                </div>
                                <footer class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                    <button type="submit"
                                            class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 hover:bg-[rgba(0,0,0,0.2)]"
                                    >
                                        Submit
                                    </button>
                                    <button type="button"
